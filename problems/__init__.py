...
default_variables = dict(
    # Temporal settings
    dt=0.001,  # timestep
    theta=0.501, #501,  # temporal integration
    ...
    # Spatial settings
    v_deg=2,  #22 velocity degree
    p_deg=1,  # pressure degree
    d_deg=1,  # solid deformation degree
    ...
    recompute=1,  # recompute the Jacobian after "recompute" Newton iterations
